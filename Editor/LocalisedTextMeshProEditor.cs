...
namespace UnityEditor.UI
{
    ...
    public sealed class LocalisedTextMeshProEditor : Editor
    {

        private LocalisedTextMeshPro _text;
        private SerializedProperty _propertyKey;
        private SerializedProperty _propertyLanugage;

        private void OnEnable()
        {
            _text = target as LocalisedTextMeshPro;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (keyUpdated)
            {
                _text.GetComponent<TMP_Text>().text = LocalisationController.instance.GetString(_propertyKey.stringValue, _propertyLanugage.stringValue);
                GUI.changed = true;
            }
        }
